...
import rocketStuff.RocketMathApplet;

/**
   Graphs path of the Rocket from the RocketMath class. Draws the x and y axis. Also, draws
   "tick" marks along the x and y axis at every 1/8 of the distance.
...
public class DrawGraph extends JApplet
{
    ...
    int ratio = 2 * sHeight / (numMarks);			//the ratio between the height and the numMarks, does nothing at the moment
    
   //TODO: fix numMarks and ratio so that the graph has numMarks marks on each axis
